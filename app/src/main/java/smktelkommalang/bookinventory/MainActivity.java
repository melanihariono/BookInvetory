package smktelkommalang.bookinventory;
...
import smktelkommalang.bookinventory.activity.BookFormActivity;
import smktelkommalang.bookinventory.adapter.BooksAdapter;
import smktelkommalang.bookinventory.adapter.DividerDecoration;
import smktelkommalang.bookinventory.helper.HelperFunction;
...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private void prepareBookData() {
        Book book = new Book("9780439064873", "Harry Potter And The Chamber Of Secret", "J.K. Rowling", 2000, "Fantasy, Thriller, Mystery", "This is some synopsis", R.drawable.hp_chamber);
        bookList.add(book);
